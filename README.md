# nvim-treesitter-queries-pod

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-pod/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-pod/actions/workflows/validate.yml)

Neovim tree-sitter queries for **pod**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-pod",
...
- [ ] Changes are scoped to `pod` — do not include files for other languages
